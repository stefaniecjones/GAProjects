...
function toggleDropDown() {
    document.querySelector(".rover-header-right-drop-down").classList.toggle("visible");
}

document.querySelector('.rover-header-right-mobile').addEventListener('click', toggleDropDown);